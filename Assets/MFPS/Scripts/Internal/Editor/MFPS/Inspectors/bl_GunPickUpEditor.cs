...
public class bl_GunPickUpEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (!serializedObject.isEditingMultipleObjects)
            script.GunID = EditorGUILayout.Popup("Gun ID ", script.GunID, bl_GameData.Instance.AllWeaponStringList(true, true), EditorStyles.toolbarDropDown);
        ...
        if (info.Type != GunType.Melee && info.Type != GunType.Grenade)
        {
