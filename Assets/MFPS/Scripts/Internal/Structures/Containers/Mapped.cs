...
namespace MFPS.InputManager
{
    ...
    public class Mapped
    {
        public List<ButtonData> ButtonMap = new();
    }
    ...
    {
        private Dictionary<string, ReorderableList> _reorderableLists = new();
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else
            {
                ...
                property.isExpanded = EditorGUI.Foldout(position, property.isExpanded, "Buttons Map", true);
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (!_reorderableLists.ContainsKey(property.propertyPath) || _reorderableLists[property.propertyPath].index > _reorderableLists[property.propertyPath].count - 1)
            {
                ...
                _reorderableLists[property.propertyPath].drawHeaderCallback += (Rect rect) =>
                {
                    ...
                    var indent = EditorGUI.indentLevel;
                    EditorGUI.indentLevel++;
                    property.isExpanded = EditorGUI.Foldout(rect, property.isExpanded, "Buttons Map", true);
                    EditorGUI.indentLevel = indent;
                };
            }
