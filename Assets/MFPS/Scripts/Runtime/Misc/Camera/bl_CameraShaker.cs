...
public class bl_CameraShaker : bl_CameraShakerBase
{
    ...
    public Vector3 ShakePerlinNoise(float amplitude, float frequency, int octaves, float persistance, float lacunarity, float burstFrequency, int burstContrast, float influence)
    {
        valX = 0;
        valY = 0;
        amplitude *= 10;
