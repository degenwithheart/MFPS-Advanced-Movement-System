...
public class bl_Crosshair : bl_CrosshairBase
{
    ...
    protected override void Awake()
    {
        ...
        if (HitMarkerRoot != null)
        {
            ...
            HitMarkerRoot.SetParent(transform, false); // show hit marker even when the crosshair is hidden
        }
    ...
    protected override void OnEnable()
    {
        ...
        RootContent.gameObject.SetActive(bl_GameData.CoreSettings.showCrosshair);
    }
    ...
    {
        if (Block || !bl_GameData.CoreSettings.showCrosshair)
            return;
    ...
    /// 
    /// </summary>
    public override void OnHit(bool letal = false)
    {
        if (HitMarkerRoot == null)
            return;
