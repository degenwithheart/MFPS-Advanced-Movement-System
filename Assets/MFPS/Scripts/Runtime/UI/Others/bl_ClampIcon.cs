...
namespace MFPS.Runtime.UI
{
    public class bl_ClampIcon : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            viewportPoint = bl_CameraIdentity.CurrentCamera.WorldToViewportPoint(position);
        ...
        {
            if (bl_CameraIdentity.CurrentCamera == null) return false;

            Plane plane = new Plane(bl_CameraIdentity.CurrentCamera.transform.forward, bl_CameraIdentity.CurrentCamera.transform.position);
