...
public sealed class bl_AIShooterNetwork : bl_MonoBehaviour, IPunObservable
{
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        else
        {
            ...
            {
                m_Transform.SetLocalPositionAndRotation(correctPlayerPos, correctPlayerRot);
                receivePackages++;
            }
        }
    }
    ...
    public override void OnUpdate()
    {
        ...
        {
            m_Transform.SetLocalPositionAndRotation(Vector3.Lerp(m_Transform.localPosition, correctPlayerPos, Time.deltaTime * 7),
                Quaternion.Lerp(m_Transform.localRotation, correctPlayerRot, Time.deltaTime * 7));
