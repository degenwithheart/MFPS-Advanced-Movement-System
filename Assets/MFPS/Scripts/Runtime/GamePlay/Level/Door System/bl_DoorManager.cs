...
namespace MFPS.Runtime.Level
{
    public class bl_DoorManager : bl_MonoBehaviour
    {
        ...
        private readonly List<bl_DoorBase> toUpdateDoors = new List<bl_DoorBase>();
        ...
        public static bl_DoorManager Instance
        {
            get
            {
                if (_instance == null) _instance = FindAnyObjectByType<bl_DoorManager>();
                return _instance;
            }
        }
    }
    ...
    public class bl_DoorManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                var all = FindObjectsByType<bl_DoorBase>(FindObjectsSortMode.None);
