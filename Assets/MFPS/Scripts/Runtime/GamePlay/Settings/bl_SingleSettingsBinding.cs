    ...
    public class bl_SingleSettingsBinding : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            if (!string.IsNullOrEmpty(SettingKeyName))
            {
                ...
                {
                    Debug.LogWarning($"Setting {SettingKeyName} is a invalid type", gameObject); return;
                }
            }
        ...
        void Localize(Dictionary<string, string> data)
        {
            ...
            if (optionTextTMP != null)
            {

                if (bl_Localization.CurrentLangFont != null)
                {
                    if (defaultFont == null)
                    {
                        defaultFont = optionTextTMP.font;
                    }
                    optionTextTMP.font = bl_Localization.CurrentLangFont;
                }
                else
                {
                    if (defaultFont != null)
                    {
                        optionTextTMP.font = defaultFont;
                    }
                }
            }
