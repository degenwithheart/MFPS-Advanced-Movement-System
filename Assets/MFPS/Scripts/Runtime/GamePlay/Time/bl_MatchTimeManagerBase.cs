...
public abstract class bl_MatchTimeManagerBase : bl_MonoBehaviour
{
    ...
    /// 
    /// </summary>
    public abstract void StartNewRoundCountdown();
    ...
    /// </summary>
    /// <returns></returns>
    public static bool HaveTimeStarted()
    {
        if (Instance == null) return true;

        return Instance.TimeState == RoomTimeState.Started;
    }
    ...
    public static bl_MatchTimeManagerBase Instance
    {
        get
        {
            if (_instance == null) { _instance = FindAnyObjectByType<bl_MatchTimeManagerBase>(); }
            return _instance;
        }
    }
}