...
namespace MFPS.Runtime.FriendList
{
    public class bl_FriendListUI : bl_FriendListUIBase
    {
        ...
        private readonly List<bl_FriendInfoBase> cacheFriendsInfo = new List<bl_FriendInfoBase>();
        ...
        {
            if (bl_FriendListBase.Instance.FriendsCount <= 0 || bl_PhotonNetwork.InRoom)
            {
                return;
            }
