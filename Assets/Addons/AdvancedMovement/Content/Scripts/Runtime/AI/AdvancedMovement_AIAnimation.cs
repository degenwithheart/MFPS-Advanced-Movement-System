...
namespace FC_AdvancedMovement.AI
{
    ...
    public class AdvancedMovement_AIAnimation : MonoBehaviour
    {
        ...
        private object slopeMovement; // Late-bound to avoid compile dependency
        ...
        private void Awake()
        {
            ...
            if (slopeType != null)
            {
                slopeMovement = GetComponent(slopeType);
            }
        ...
        private void UpdateSlopeAnimations()
        {
            ...
            if (isSkiing)
            {
                ...
                float velocity = slopeMovement.GetCurrentSpeed();
                float normalizedSpeed = Mathf.Clamp01(velocity / slopeMovement.maxSkiSpeed);
